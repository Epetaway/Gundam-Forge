...
-- 3c. Meta tracking (archetype and card performance over time)
...
create index if not exists idx_archetype_stats_history_archetype
  on public.archetype_stats_history(archetype_id, snapshot_id);
create index if not exists idx_archetype_stats_history_rank
  on public.archetype_stats_history(meta_rank);
create index if not exists idx_card_performance_card
  on public.card_performance(card_id, snapshot_id);
create index if not exists idx_card_performance_archetype
  on public.card_performance(archetype_id, snapshot_id);
...
-- ============================================================
-- Increment view count with rate limiting (24h dedup)
-- ============================================================
...
-- ============================================================
-- Trending decks RPC
-- Score = (recent_likes * 3 + views) / age_hours^1.5
-- ============================================================
