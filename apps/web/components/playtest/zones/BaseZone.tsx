...
export function BaseZone({
  ...
  return (
    <div className="border-2 border-border rounded-lg bg-surface-elevated/70 p-3">
      ...
      {baseCard ? (
        <>
          ...
          <div className="space-y-1">
            ...
            <div className="bg-surface rounded-lg h-8 overflow-hidden border border-border flex items-center px-2">
        ...
        <div className="bg-surface/40 border-2 border-dashed border-border rounded-lg p-4 text-center">
