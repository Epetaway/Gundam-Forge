...
export function QtyBadge({ qty, mode }: QtyBadgeProps): JSX.Element | null {
  ...
  return (
    <span className="pointer-events-none absolute right-2 top-2 z-10 rounded-sm bg-black/70 px-2 py-0.5 font-mono text-[11px] font-bold leading-none text-white">
      x{qty}
    </span>
  );
}
